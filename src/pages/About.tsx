  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold mb-8 text-[#000000]">About INTILey</h1>
        <Card className="bg-white shadow-lg">
          <CardContent className="p-6">
            ...
            <p className="text-[#000000] mb-4">
              INTILey is at the forefront of revolutionizing the legal industry through artificial intelligence. 
